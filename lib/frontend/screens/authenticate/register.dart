...
class RegisterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  BlocProvider(create: (BuildContext context)=>RegisterCubit(authRepository: authRepository),
                              ...
                              child: TextButton(
                                ...
                                onPressed: () {
                                  if (formKey.currentState!.validate()) {
                                    cubit.userRegistering(email: emailController.text
                                        , userName: nameController.text,
                                        phone: phoneController.text,
                                        password: passwordController.text,
                                        birthDate: dateController.text, gender:gender==0?'Male':'Female');
                                  }
                                },
                              ),
                            ),
