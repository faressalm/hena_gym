...
import 'package:hena_gym/frontend/screens/authenticate/validator.dart';
  ...
  void main(){
    ...
    test('very long password', (){
      var result = Validator.validatePassword('adfgssssssdfadsgdfdsafADADFDAssssssssssssfaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaddddddddddddddddddddddddddddddddddddddd');
    ...
    test('long phone number', (){
      var result =Validator.validatePhone('31243245421413542514354215432542123521235421354215435421541254');
    ...
    test('wrong format for birthdate', (){
      var result = Validator.validateBirthdate('fadsgafgdafdsgadFSFAGFAFgafssgfsafds');
      expect(result,Validator.wrongBirthDateFormat);
    });
  }
